  ...
  return (
    <header className='bg-custom-color shadow-md'>
      <div className='flex justify-between items-center max-w-6xl mx-auto p-3'>
        ...
        <ul className='flex gap-4'>
          <Link to='/'>
            <li className='hidden sm:inline text-slate-700 text-xl hover:text-slate-100 duration-300'>
              Home
            </li>
          </Link>
          <Link to='/about'>
          ...
          <Link to='/profile'>
            {currentUser ? (
              ...
              <li className='text-slate-700 text-xl hover:text-slate-100 duration-300'>
                Sign In
              </li>
            )}
          </Link>
